...
@Component({
  selector: 'app-aggiungi-fattura-da-id',
  templateUrl: './aggiungi-fattura-da-id.component.html',
  styleUrls: ['./aggiungi-fattura-da-id.component.css']
})
export class AggiungiFatturaDaIdComponent implements OnInit {
    myId: any;
  data = new Date();
  fattura: Fattura = {
    data: "",
  ...
  aggiungi() {
    ...
    this.mieFatture.postFattura(this.fattura)
      .subscribe(
        ...
        error => {
          alert("Fattura non salvata. ID non esistente")
